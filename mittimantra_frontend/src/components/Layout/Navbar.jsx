...
import { FaSeedling, FaBars, FaTimes, FaLeaf, FaTint, FaBug, FaChartLine, FaInfoCircle, FaUser, FaSignOutAlt, FaSignInAlt } from 'react-icons/fa';
...
const Navbar = () => {
  ...
  const navigation = [
    ...
    { name: 'Pest Control', path: '/pest-control', icon: FaBug },
