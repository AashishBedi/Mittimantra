...
import { FaSeedling, FaLeaf, FaTint, FaBug, FaChartLine, FaArrowRight } from 'react-icons/fa';
...
const Home = () => {
  const features = [
    ...
    },
    {
      icon: FaBug,
      title: 'Pest Control',
      description: 'Identify pests and diseases with comprehensive organic and chemical control solutions.',
      link: '/pest-control',
      color: 'bg-orange-500',
    },
    {
      ...
      description: 'Track your farming decisions, view insights, and monitor crop patterns over time.',
      link: '/dashboard',
      color: 'bg-purple-500',
    },
  ];
